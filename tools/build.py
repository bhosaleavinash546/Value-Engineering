...
PAGES = [
  dict(slug="job-plan", old="save", nav="Job Plan", short="The 6-Phase Job Plan",
       ...
       tldr="A Value Engineering study runs six phases in a fixed order: <b>Information</b>, <b>Function Analysis</b>, <b>Creative</b>, <b>Evaluation</b>, <b>Development</b> and <b>Presentation</b>. The order matters — facts before functions, functions before ideas, and judgement only after the ideas are all on the table. Start early: most of a product's cost is committed by the end of function analysis.",
  ...
  dict(slug="function-analysis", old="fast", nav="Function Analysis", short="Function Analysis & FAST",
       ...
       tldr="Describe the product as <b>verb–noun functions</b> (“heat water”, “indicate status”), arrange them in a <b>FAST diagram</b> so HOW and WHY read left-to-right, then load every pound of cost onto the functions it serves. Comparing each function's cost with its <b>worth</b> — the cheapest reliable way to do it — gives the <b>Value Index</b>, and the biggest gaps become your targets.",
  ...
  dict(slug="cost-levers", old="levers", nav="Cost Levers", short="36 Cost Levers",
       ...
       tldr="Product cost comes down through six lever families: <b>design</b>, <b>materials</b>, <b>manufacturing</b>, <b>sourcing</b>, <b>packaging &amp; logistics</b>, and <b>complexity &amp; lifecycle</b>. Each of the 36 levers here states where it bites and the savings range it typically delivers. Not sure where to start? The <b>Lever Selector</b> ranks the top five for your industry and pain points.",
  ...
  dict(slug="ideation", old="ideation", nav="Ideation", short="Idea-Generation Techniques",
       ...
       tldr="The Creative Phase is about <b>quantity first, judgement later</b>. Twelve techniques keep ideas flowing — silent <b>brainwriting 6-3-5</b> so everyone contributes, <b>SCAMPER</b> as a checklist, <b>TRIZ</b> for “stronger but lighter” contradictions, and analogy for stealing solutions from other industries. Ideate on the <b>function</b>, never the current part.",
  ...
  dict(slug="technology", old="tech", nav="Technology", short="Modern Cost Technology",
       ...
       tldr="Modern tools compress weeks of cost analysis into hours: <b>AI should-cost engines</b> read CAD and estimate piece cost before any quote, <b>cleansheet models</b> give negotiations a factual backbone, <b>CT scanning</b> digitises competitor parts without destroying them, and <b>spend analytics</b> finds price outliers in data you already own. The tools multiply a good method — they don't replace it.",
  ...
  dict(slug="benchmarking", old="benchmark", nav="Benchmarking", short="Teardown & Benchmarking",
       ...
       tldr="A teardown answers VE's hardest question — <i>what is this function worth?</i> — with physical evidence. Five steps: <b>document</b> everything before touching a screw, <b>disassemble</b> level by level with a stopwatch, <b>capture</b> every part in a BOM, <b>should-cost</b> each part at the competitor's assumptions, and <b>harvest</b> the findings into your idea funnel. Compare on six dimensions, not price alone.",
  ...
  dict(slug="industries", old="industries", nav="Industries", short="Industry Playbooks",
       ...
       tldr="The method is universal but the winning levers are not. Each of the eight playbooks shows a typical <b>cost structure</b>, the <b>highest-yield levers</b> for that industry, and its <b>signature move</b> — for example, in automotive 60–75% of vehicle cost sits in purchased parts, so sourcing and supplier VAVE lead; in consumer goods, packaging and SKU complexity do.",
  ...
  dict(slug="governance", old="governance", nav="Governance", short="Savings Funnel & KPIs",
       ...
       tldr="One-off studies decay; programmes compound. A governed <b>savings funnel</b> moves ideas from generated to implemented — only about 1 in 13 reaches the P&amp;L, which is why every stage needs an owner and a date. A handful of <b>KPIs</b> (funnel coverage, idea conversion, cost transparency, savings velocity) and a fixed <b>monthly cadence</b> keep it honest.",
  ...
  dict(slug="toolkit", old="toolkit", nav="Toolkit", short="Free Toolkit",
       ...
       tldr="Seven field-tested worksheets, each in two formats: a <b>print-ready page</b> you can save as PDF, and an <b>editable Excel file</b> with live formulas. Free for personal and internal company use with attribution. Every template links to the Academy module that teaches how to use it.",
  ...
  dict(slug="glossary", old="glossary", nav="Glossary", short="Glossary",
       ...
       tldr="Every key term used across VAVEhub and the VE Academy, defined in plain English — from <b>basic function</b> and <b>worth</b> to <b>should-cost</b>, <b>LPP</b> and <b>target costing</b>. Type in the search box to filter, or link straight to any term.",
